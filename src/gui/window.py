...
class SteamyMainWindow(QtW.QMainWindow):
    ...
    def on_pornify_click(self) -> None:
        ...
        def on_done() -> None:
            ...
            if self.steam.is_running():
                ...
                info_message(QtW.QMessageBox.Icon.NoIcon, "Pornify Done", "When you start Steam, it will be using porn images.")
    ...
    def on_resteam_click(self) -> None:
        ...
        if self.steam.is_running():
            ...
            info_message(QtW.QMessageBox.Icon.NoIcon, "Resteam Done", "When you start Steam, it will be back to normal.")
